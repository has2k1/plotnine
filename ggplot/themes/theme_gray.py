...
def _set_default_theme_rcparams(gg):
    ...
    # The next two must must be string, not float to be convertable to a color
    gg.rcParams["figure.facecolor"] = "1.0" # "white"
    gg.rcParams["figure.edgecolor"] = "0.50" # some kind of grey
