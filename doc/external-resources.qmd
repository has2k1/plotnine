...
[Grammer of graphics with plotnine](https://www.kaggle.com/residentmario/grammer-of-graphics-with-plotnine-optional/)

:   A good introductory tutorial on how to use `plotnine`. It is part
    of the [data visualization](https://www.kaggle.com/learn/data-visualisation)
    track from kaggle's free online `course (https://www.kaggle.com/learn/overview)`.

[Python Plotting for Exploratory Analysis](http://pythonplot.com/)
