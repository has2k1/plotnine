...
- [](:class:`~plotnine.facets.facet_grid`) now accepts two parameters,
...
- The `facets` parameter in [](:class:`~plotnine.facets.facet_wrap`) has
...
- The `space` parameter of [](:class:`~plotnine.facets.facet_grid`) now
