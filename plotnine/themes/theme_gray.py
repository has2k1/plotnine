...
class theme_gray(theme):
    ...
    def __init__(self, base_size=11, base_family='DejaVu Sans'):
        ...
        theme.__init__(
            self,
            line=element_line(color='black', size=1, linetype='solid', lineend='butt'),
            rect=element_rect(fill='white', color='black', size=1, linetype='solid'),
            text=element_text(
                family=base_family,
                style='normal',
                color='black',
            ...
            axis_text_x=element_text(va='top', margin={'t': half_line * 0.8 / 2}),
            axis_text_y=element_text(ha='right', margin={'r': half_line * 0.8 / 2}),
