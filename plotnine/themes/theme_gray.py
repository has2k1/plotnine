...
class theme_gray(theme):
    ...
    def __init__(self, base_size=11, base_family=None):
        ...
        super().__init__(
            ...
            axis_text_x_bottom=element_text(margin=margin(t=fifth_line)),
            axis_text_x_top=element_text(margin=margin(b=fifth_line)),
            axis_text_y=element_text(ha="right"),
            axis_text_y_left=element_text(margin=margin(r=fifth_line)),
            axis_text_y_right=element_text(margin=margin(l=fifth_line)),
